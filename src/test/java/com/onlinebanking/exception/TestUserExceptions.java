...
public class TestUserExceptions {
	...
	public void testCreateUserInvalidDataException() throws Exception {
		...
		yakshaAssert(currentTest(), (userDTOResponse == null ? "true" : "false"), exceptionTestFile);
	}
	...
	public void testGetUserByIdResourceNotFoundException() throws Exception {
		...
		when(this.userService.getUserById(userDTO.getId()))
				.thenThrow(new ResourceNotFoundException("Account", "Account not found with id: ", userDTO.getId()));
	...
	@Test
	public void testSearchUserByBogusUserName() throws Exception {
		UserDTO userDTO = MasterData.getUserDTO();

		RequestBuilder requestBuilder = MockMvcRequestBuilders
				.get("/users/search?name=" + userDTO.getName())
				.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON);
